...
- Release binary built successfully for the current Apple Silicon Mac. FFmpeg and untrunc remain external. No Windows or Intel Mac runtime test was performed. A three-OS GitHub Actions workflow is supplied; it has not run remotely.
