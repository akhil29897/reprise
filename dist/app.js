...
$("#verified-coverage").innerHTML =
  `<div class="verified-list"><div class="verified-row"><span class="badge good">TESTED</span><div><strong>PCM WAV length repair</strong><p>Synthetic fixtures: incorrect RIFF size, incomplete trailing samples, and unchanged surviving audio bytes. Runs in your browser.</p></div></div><div class="verified-row"><span class="badge good">TESTED</span><div><strong>Local H.264 / AAC MP4 remux & validation</strong><p>Generated video fixtures with every audio/video stream decoded. Requires FFmpeg in the companion. This is not camera-wide coverage.</p></div></div><div class="verified-row"><span class="badge warn">EXPERIMENTAL</span><div><strong>Missing-index reconstruction & Sony RSV</strong><p>Reference-based engine integration. Generated missing-moov tests differ by encoding mode. Real camera RSV fixtures are still needed.</p></div></div></div>`;
renderCatalog();
